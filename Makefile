...
OBJ = Wave_gpu.o Wave_kernel.o Wavestep.o Flow_kernel.o Sedimentkernel.o Flow_CPU.o makejonswap.o red_input.o Sediment_CPU.o tools.o Wave_CPU.o writenetcdf.o
...
Wave_gpu.o:Wave_gpu.cu 
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
	
Flow_CPU.o:Flow_CPU.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
	
read_input.o:read_input.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
	
Sediment_CPU.o:Sediment_CPU.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
	
tools.o:tools.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
	
Wave_CPU.o:wave_CPU.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
